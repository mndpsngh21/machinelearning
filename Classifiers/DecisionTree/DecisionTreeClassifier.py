...
# We are going to use only parameters for criterion which is used to measure
# quality of a split, and random state for same result and thats all and we are done.
...
plt.title('DecisionTreeClassifierr (Training set)')
plt.xlabel('Age')
