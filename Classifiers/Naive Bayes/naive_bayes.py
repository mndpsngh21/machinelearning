# Naive Bayes Theorm Regression
# It based on probability calculation following Bayes theorm, where we calculate 
# probability of all classes and select which has highest probability.
...
# expected result from is [[65 3]
#                          [7 25]  ]
# which means only 10 are wrong predictions
