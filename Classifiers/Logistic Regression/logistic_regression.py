# Logistic Regression
# This is different then linear regression model as here logic works on probability
# occurance of any event or action, we are taking simple example of predicting a
# person can buy or not a SUV car. the logic will work for simply on age and salary 
...
# we are using random state to produce same result everytime, so randomness seed should be same
