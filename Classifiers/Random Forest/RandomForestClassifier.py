...
# We are going to use below parameters for classification
# n_estimators: which is size of forest and 
# criterion: which is used to measure quality of a split
# random state: for same result and thats all and we are done.
